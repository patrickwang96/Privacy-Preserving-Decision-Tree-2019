...
#ifndef PRIVACY_PRESERVING_DECISION_TREE_2019_SERVER_DECISION_TREE_H
#define PRIVACY_PRESERVING_DECISION_TREE_2019_SERVER_DECISION_TREE_H
...
void server_node_eval_phase2(std::vector<int> &a_2, std::vector<mpz_class> &result, const triplet_b &tri_b, NetAdapter *net);
...
#endif //PRIVACY_PRESERVING_DECISION_TREE_2019_SERVER_DECISION_TREE_H
